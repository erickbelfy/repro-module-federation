...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/dh/dt6_hghx2ys19b83sw_qr9m80000gp/T/jest_dy",
  ...
  coverageThreshold: {
    global: {
      branches: 69, // @todo improve me ASAP
      functions: 76,
      lines: 77,
      statements: 77,
    },
  ...
  modulePathIgnorePatterns: ['<rootDir>/build/', '<rootDir>index.js'],
  ...
  resolver: '<rootDir>/test/resolvers.ts',
